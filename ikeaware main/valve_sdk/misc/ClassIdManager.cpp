...
{
	ServerClass* serverclass = g_ServerGameDll->GetAllServerClasses();
	int id = 0;
	while (serverclass)
	{
...
ClassIdManager::ClassIdManager()
{
	...
	CBumpMine = GetClassID("CBumpMine");
	CBumpMineProjectile = GetClassID("CBumpMineProjectile");
	CC4 = GetClassID("CC4");
	...
	CPlayerPing = GetClassID("CPlayerPing");
	...
	CWeaponShield = GetClassID("CWeaponShield");
