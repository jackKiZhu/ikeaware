...
{
public:
	void FixNullInventory(Writer& cache);
	void ClearEquipState(Writer& object);
	void AddAllItems(Writer& object);
	void AddItem(Writer& object, int index, int itemIndex, int rarity, int paintKit, int seed, float wear, std::string name);
